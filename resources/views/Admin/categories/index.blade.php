          ...
          <head>
              ...
              <link rel="apple-touch-icon" sizes="180x180"
                  href={{ asset('dashassets//img/favicons/apple-touch-icon.png') }}>
              <link rel="icon" type="image/png" sizes="32x32"
                  href={{ asset('dashassets/favicons/favicon-32x32.png') }}>
                              ...
                              <div class="row g-5">
                                  <div>
                                      ...
                                      <a data-bs-toggle="modal" data-bs-target="#exampleModal"
                                          class="btn btn-primary">Ajouer categorie</a>
                                  </div>
                          ...
                          <form action="/Admin/categories/store" method="post">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="mb-3">
                                      ...
                                      <label class="form-label" for="exampleFormControlInput1">Ajouter
                                          Categorie</label>
                          ...
                          <div class="modal-content">
                              <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Modifier Categorie:<span
                                          class="text primary">{{ $c->name }}</span></h5>
